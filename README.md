This is a test suite that supports the CoAP protocol using the [CoAPthon3](https://github.com/Tanganelli/CoAPthon3) library based on the [ACME-oneM2M-CSE](https://github.com/ankraft/ACME-oneM2M-CSE).
